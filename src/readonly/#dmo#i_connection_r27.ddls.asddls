@AbapCatalog.sqlViewName: '/DMO/ICONNE_R27'
...
define view /DMO/I_Connection_R27
  as select from /dmo/connecti_27 as Connection

  association [1..*] to /DMO/I_Flight_R27 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier27  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport27',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
