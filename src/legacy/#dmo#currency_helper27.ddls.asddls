@AbapCatalog.sqlViewName: '/DMO/CURRHLP27'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Help View for Currency Conversion'
define view /DMO/CURRENCY_HELPER27
  with parameters
    amount             : /dmo/total_price27,
    source_currency    : /dmo/currency_code27,
    target_currency    : /dmo/currency_code27,
    exchange_rate_date : /dmo/booking_date27

  as select from /dmo/agency27
