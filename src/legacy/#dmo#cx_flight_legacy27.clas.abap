CLASS /dmo/cx_flight_legacy27 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_27',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_27',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id27 OPTIONAL
        booking_id            TYPE /dmo/booking_id27 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id27 OPTIONAL
        agency_id             TYPE /dmo/agency_id27 OPTIONAL
        customer_id           TYPE /dmo/customer_id27 OPTIONAL
        carrier_id            TYPE /dmo/carrier27-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_27-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_27-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date27 OPTIONAL
        end_date              TYPE /dmo/end_date27 OPTIONAL
        booking_date          TYPE /dmo/booking_date27 OPTIONAL
        flight_date           TYPE /dmo/flight_date27 OPTIONAL
        status                TYPE /dmo/travel_status27 OPTIONAL
        currency_code         TYPE /dmo/currency_code27 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id27,
          mv_booking_id            TYPE /dmo/booking_id27,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id27,
          mv_agency_id             TYPE /dmo/agency_id27,
          mv_customer_id           TYPE /dmo/customer_id27,
          mv_carrier_id            TYPE /dmo/carrier27-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_27-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_27-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date27,
          mv_end_date              TYPE /dmo/end_date27,
          mv_booking_date          TYPE /dmo/booking_date27,
          mv_flight_date           TYPE /dmo/flight_date27,
          mv_status                TYPE /dmo/travel_status27,
          mv_currency_code         TYPE /dmo/currency_code27,
...
CLASS /dmo/cx_flight_legacy27 IMPLEMENTATION.
