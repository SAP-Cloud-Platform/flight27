...
INTERFACE /dmo/if_flight_legacy27
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL27
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel27     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING27
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking27    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_27
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_27 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT27
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight27 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id27.
  ...
  TYPES booking_id TYPE /dmo/booking_id27.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id27.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL27, /DMO/BOOKING27, /DMO/BOOK_SUP_27 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code27.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code27,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status27,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel27_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id27.
  INCLUDE TYPE /dmo/booking27_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id27.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id27.
  INCLUDE TYPE /dmo/book_sup_27_data.
