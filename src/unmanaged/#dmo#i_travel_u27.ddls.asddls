@AbapCatalog.sqlViewName: '/DMO/ITRAV_U27'
...
define root view /DMO/I_Travel_U27
  as select from /dmo/travel27 as Travel -- the travel table is the data source for this view

  composition [0..*] of /DMO/I_Booking_U27 as _Booking

  association [0..1] to /DMO/I_Agency27       as _Agency    on $projection.AgencyID        = _Agency.AgencyID
  association [0..1] to /DMO/I_Customer27     as _Customer  on $projection.CustomerID      = _Customer.CustomerID
...

{
    ...
    @Consumption.valueHelpDefinition: [{ entity : {name: '/DMO/I_Agency27', element: 'AgencyID'  } }]
